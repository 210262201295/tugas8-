...
password = 'sparta'
cxn_str = f'mongodb+srv://sri853761:{password}@cluster0.bd7xk8g.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
def save_ex():
    ...
    return jsonify({
        "result": "success",
        'msg': f'Your example, {example}, for the wrod, {word}, was saved!',
    })
